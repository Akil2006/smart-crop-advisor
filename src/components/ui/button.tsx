  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0 active:scale-95",
  {
    variants: {
      variant: {
        ...
        farmer: "bg-primary text-primary-foreground hover:opacity-90 shadow-card text-xl font-bold py-5 px-8 rounded-2xl gap-3",
        farmerSecondary: "bg-secondary text-secondary-foreground hover:opacity-90 shadow-card text-xl font-bold py-5 px-8 rounded-2xl gap-3",
        farmerOutline: "border-2 border-primary bg-transparent text-primary hover:bg-primary hover:text-primary-foreground text-xl font-bold py-5 px-8 rounded-2xl gap-3",
      },
      size: {
